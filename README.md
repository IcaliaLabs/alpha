# **Alpha**
### ***Craft your own <span style="color: #dc2a23">(fully customizable)</span> web-based chatbot***
...
## **Installation**
Alpha is built to run on **Docker**. However you can run it locally as long as you have **NodeJS** as well as **npm** or **yarn** in your system.
#### **Development**
